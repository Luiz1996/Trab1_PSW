...
public class C_Livro implements Serializable {
    ...
    private M_Livro livro = new M_Livro(0, "", "", "", "", "", "", "", 0, -1);
    private M_Livro_DAO livroDAO = new M_Livro_DAO();
    ...
    public String realizarCadastroLivro() throws SQLException { return livroDAO.cadastrarLivro(livro); }

    //chama método para consultar livro(s)
    public List<M_Livro> realizarConsultaLivro() throws SQLException { return livroDAO.consultarLivro(livro, 0); }

    public List<M_Livro> realizarConsultaLivroEmp() throws SQLException { return livroDAO.consultarLivro(livro, 1); }

    public List<M_Livro> realizarConsultaLivroBibliotecario() throws SQLException { return livroDAO.consultarLivroBibliotecario(livro, 0); }

    public List<M_Livro> realizarConsultaLivroBibliotecarioSoAtivos() throws SQLException { return livroDAO.consultarLivroBibliotecario(livro, 1); }
